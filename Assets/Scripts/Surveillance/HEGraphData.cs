namespace JSM.Surveillance.Surveillance
{
    ...
    {
        public struct Vertex { public Vector2 ij; public Vertex(float i, float j){ ij = new Vector2(i,j); } }
        ...
        public List<HEHalf> halfEdges { get; private set; } = new List<HEHalf>();
        public List<HEFace> faces { get; private set; } = new List<HEFace>();
        
        
        public void Clear() { verts.Clear(); edges.Clear(); }

        private float EdgeEpsilon = 1e-4f;
        private readonly HashSet<int> pinned = new();
